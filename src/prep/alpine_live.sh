...
main() {
    ...
    prep_packages="bash btrfs-progs coreutils curl efibootmgr git lsblk mount parted python3 sudo tmux tzdata umount" #  [[[[coreutils needed for ln -srf]]]] make fakeroot dialog [[[[[#### default mount and umount from busybox gives errors]]]] ---> REMOVE bash
