...
- [What is astOS?](https://github.com/ashos/astos#what-is-astos)
- [astOS compared to other similar distributions](https://github.com/ashos/astos#astos-compared-to-other-similar-distributions)
- [ast and astOS documentation](https://github.com/ashos/astos#additional-documentation)
  - [Installation](https://github.com/ashos/astos#installation)
  - [Post installation](https://github.com/ashos/astos#post-installation-setup)
  - [Snapshot management and deployments](https://github.com/ashos/astos#snapshot-management)
  - [Package management](https://github.com/ashos/astos#package-management)
- [Additional documentation](https://github.com/ashos/astos#additional-documentation)
  - [Updating the pacman keys](https://github.com/ashos/astos#fixing-pacman-corrupt-packages--key-issues)
  - [Saving configuration changes in /etc persistently](https://github.com/ashos/astos#saving-configuration-changes-made-in-etc)
  - [Configuring dual boot](https://github.com/ashos/astos#dual-boot)
  - [Updating ast itself](https://github.com/ashos/astos#updating-ast-itself)
  - [Debugging ast](https://github.com/ashos/astos#debugging-ast)
- [Known bugs](https://github.com/ashos/astos#known-bugs)
- [Contributing](https://github.com/ashos/astos#contributing)
- [Community](https://github.com/ashos/astos#community)
...
```
git clone "https://github.com/ashos/astos"
cd astos
```
...
- Report issues/bugs on the [Github issues page](https://github.com/ashos/astos/issues)
...
- This update only updates the system packages, in order to update ast itself see [this section](https://github.com/ashos/astos#updating-ast-itself)
...
- If you run into any issues, report them on [the issues page](https://github.com/ashos/astos/issues)
